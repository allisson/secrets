...
// DekRepository implements DEK persistence for PostgreSQL.
...
func (p *DekRepository) Create(ctx context.Context, dek *cryptoDomain.Dek) error {
...
func (p *DekRepository) Update(ctx context.Context, dek *cryptoDomain.Dek) error {
	querier := database.GetTx(ctx, p.db)
...
func (p *DekRepository) GetBatchNotKekID(
	ctx context.Context,
	kekID uuid.UUID,
	limit int,
) ([]*cryptoDomain.Dek, error) {
...
// NewDekRepository creates a new PostgreSQL DEK repository.
