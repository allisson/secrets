...
func TestMySQLAuditLogRepository_ListCursor_FirstPage(t *testing.T) {
	db := testutil.SetupMySQLDB(t)
	defer testutil.TeardownDB(t, db)
	defer testutil.CleanupMySQLDB(t, db)
	...
	// Create test client for foreign key constraint
	clientID := testutil.CreateTestClient(t, db, "mysql", "test-cursor-first")
...
func TestMySQLAuditLogRepository_ListCursor_SubsequentPages(t *testing.T) {
	db := testutil.SetupMySQLDB(t)
	defer testutil.TeardownDB(t, db)
	defer testutil.CleanupMySQLDB(t, db)
	...
	// Create test client for foreign key constraint
	clientID := testutil.CreateTestClient(t, db, "mysql", "test-cursor-pages")
...
func TestMySQLAuditLogRepository_ListCursor_EmptyResult(t *testing.T) {
	db := testutil.SetupMySQLDB(t)
	defer testutil.TeardownDB(t, db)
	defer testutil.CleanupMySQLDB(t, db)
...
func TestMySQLAuditLogRepository_ListCursor_WithFilters(t *testing.T) {
	db := testutil.SetupMySQLDB(t)
	defer testutil.TeardownDB(t, db)
	defer testutil.CleanupMySQLDB(t, db)
...
func TestMySQLAuditLogRepository_ListCursor_ByClientID(t *testing.T) {
	db := testutil.SetupMySQLDB(t)
	defer testutil.TeardownDB(t, db)
	defer testutil.CleanupMySQLDB(t, db)
	...
	// Create test clients
	clientID1 := testutil.CreateTestClient(t, db, "mysql", "client-1")
	clientID2 := testutil.CreateTestClient(t, db, "mysql", "client-2")
