...
//
// Provides PostgreSQL persistence with transaction support via database.GetTx().
// PostgreSQL uses native UUID types.
package repository
...
// ClientRepository implements Client persistence for PostgreSQL.
