...
//   - afterName *string
//   - limit int
func (_e *MockTransitKeyRepository_Expecter) ListCursor(ctx interface{}, afterName interface{}, limit interface{}) *MockTransitKeyRepository_ListCursor_Call {
...
func (_c *MockTransitKeyUseCase_Create_Call) Return(transitKey *domain.TransitKey, err error) *MockTransitKeyUseCase_Create_Call {
	_c.Call.Return(transitKey, err)
	return _c
}
...
func (_mock *MockTransitKeyUseCase) Decrypt(ctx context.Context, name string, ciphertext string, context1 []byte) (*domain.EncryptedBlob, error) {
	ret := _mock.Called(ctx, name, ciphertext, context1)

	if len(ret) == 0 {
		panic("no return value specified for Decrypt")
	}

	var r0 *domain.EncryptedBlob
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, []byte) (*domain.EncryptedBlob, error)); ok {
		return returnFunc(ctx, name, ciphertext, context1)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string, []byte) *domain.EncryptedBlob); ok {
		r0 = returnFunc(ctx, name, ciphertext, context1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.EncryptedBlob)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, string, []byte) error); ok {
		r1 = returnFunc(ctx, name, ciphertext, context1)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
//   - ciphertext string
//   - context1 []byte
func (_e *MockTransitKeyUseCase_Expecter) Decrypt(ctx interface{}, name interface{}, ciphertext interface{}, context1 interface{}) *MockTransitKeyUseCase_Decrypt_Call {
	return &MockTransitKeyUseCase_Decrypt_Call{Call: _e.mock.On("Decrypt", ctx, name, ciphertext, context1)}
}

func (_c *MockTransitKeyUseCase_Decrypt_Call) Run(run func(ctx context.Context, name string, ciphertext string, context1 []byte)) *MockTransitKeyUseCase_Decrypt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTransitKeyUseCase_Decrypt_Call) Return(encryptedBlob *domain.EncryptedBlob, err error) *MockTransitKeyUseCase_Decrypt_Call {
	_c.Call.Return(encryptedBlob, err)
	return _c
}

func (_c *MockTransitKeyUseCase_Decrypt_Call) RunAndReturn(run func(ctx context.Context, name string, ciphertext string, context1 []byte) (*domain.EncryptedBlob, error)) *MockTransitKeyUseCase_Decrypt_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockTransitKeyUseCase) Encrypt(ctx context.Context, name string, plaintext []byte, context1 []byte) (*domain.EncryptedBlob, error) {
	ret := _mock.Called(ctx, name, plaintext, context1)
	...
	var r0 *domain.EncryptedBlob
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, []byte, []byte) (*domain.EncryptedBlob, error)); ok {
		return returnFunc(ctx, name, plaintext, context1)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, []byte, []byte) *domain.EncryptedBlob); ok {
		r0 = returnFunc(ctx, name, plaintext, context1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domain.EncryptedBlob)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, []byte, []byte) error); ok {
		r1 = returnFunc(ctx, name, plaintext, context1)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
//   - plaintext []byte
//   - context1 []byte
func (_e *MockTransitKeyUseCase_Expecter) Encrypt(ctx interface{}, name interface{}, plaintext interface{}, context1 interface{}) *MockTransitKeyUseCase_Encrypt_Call {
	return &MockTransitKeyUseCase_Encrypt_Call{Call: _e.mock.On("Encrypt", ctx, name, plaintext, context1)}
}

func (_c *MockTransitKeyUseCase_Encrypt_Call) Run(run func(ctx context.Context, name string, plaintext []byte, context1 []byte)) *MockTransitKeyUseCase_Encrypt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTransitKeyUseCase_Encrypt_Call) Return(encryptedBlob *domain.EncryptedBlob, err error) *MockTransitKeyUseCase_Encrypt_Call {
	_c.Call.Return(encryptedBlob, err)
	return _c
}

func (_c *MockTransitKeyUseCase_Encrypt_Call) RunAndReturn(run func(ctx context.Context, name string, plaintext []byte, context1 []byte) (*domain.EncryptedBlob, error)) *MockTransitKeyUseCase_Encrypt_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockTransitKeyUseCase) ListCursor(ctx context.Context, afterName *string, limit int) ([]*domain.TransitKey, error) {
	ret := _mock.Called(ctx, afterName, limit)
...
// MockTransitKeyUseCase_ListCursor_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListCursor'
type MockTransitKeyUseCase_ListCursor_Call struct {
	*mock.Call
}
...
//   - afterName *string
//   - limit int
func (_e *MockTransitKeyUseCase_Expecter) ListCursor(ctx interface{}, afterName interface{}, limit interface{}) *MockTransitKeyUseCase_ListCursor_Call {
	return &MockTransitKeyUseCase_ListCursor_Call{Call: _e.mock.On("ListCursor", ctx, afterName, limit)}
}

func (_c *MockTransitKeyUseCase_ListCursor_Call) Run(run func(ctx context.Context, afterName *string, limit int)) *MockTransitKeyUseCase_ListCursor_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockTransitKeyUseCase_Rotate_Call) Return(transitKey *domain.TransitKey, err error) *MockTransitKeyUseCase_Rotate_Call {
	_c.Call.Return(transitKey, err)
	return _c
}
