...
- [v0.9.0 Upgrade Guide](../releases/v0.9.0-upgrade.md) - Migration steps and troubleshooting
- [AGENTS.md - Audit Log Cryptographic Signing](../../AGENTS.md#audit-log-cryptographic-signing) - Implementation patterns
