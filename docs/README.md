...
- `openapi.yaml` is a baseline subset for common API flows in the current release (v0.11.0, see `docs/metadata.json`)
...
- 📦 [releases/RELEASES.md](releases/RELEASES.md) - All release notes and upgrade guides
