...
- Review [Release notes](../../releases/RELEASES.md) before upgrades
...
2. Identify caller pattern:
   - check `429` by route and token endpoint ratio in [Monitoring](../observability/monitoring.md)
...
This section documents practical limitations and tradeoffs operators should account for.
